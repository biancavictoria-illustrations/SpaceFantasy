...
[CreateAssetMenu(menuName = "Controls/SwitchButtonSprites")]
public class SwitchButtonSprites : DeviceButtonSpritesObject
{
    ...
    [SerializeField] private Sprite squareButton;
    ...
    public override Sprite GetSprite(string controlPath)
    {
        ...
        switch (controlPath)
        {
            ...
            case "Square Button": return squareButton;
