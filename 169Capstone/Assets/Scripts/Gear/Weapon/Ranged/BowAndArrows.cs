...
public class BowAndArrows : Equipment
{
    ...
    private void FireArrow()
    {
        ...
        projectileScript.Initialize(LayerMask.NameToLayer("Enemy"), player.currentDex * damageMultiplier, InputManager.instance.cursorLookDirection, 20 * Mathf.Lerp(1, 2, heldTime/maxHoldTime));
